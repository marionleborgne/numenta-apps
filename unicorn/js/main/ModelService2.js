...
const MODEL_RUNNER_PATH = path.join(
  __dirname, '..', '..', 'py', 'unicorn_backend', 'mock_model_runner.py'
);
...
export class ModelService extends EventEmitter {
   ...
   * @param  {Object} fileOpt - Input File options. See 'input_opt_schema.json'
   ...
   */
  createModel(modelId, fileOpt, aggregationOpt, modelOpt) {
    ...
    this._models.set(modelId, {
       fileOpt, aggregationOpt, modelOpt, child
    });
  }
